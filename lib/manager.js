...
module.exports = function (credentials) {
  ...
  const bottomBar1 = bottombarView(screen, 'left', '100%-2', '{bold}a{/bold}: add torrent from url  {bold}s{/bold}: start  {bold}f{/bold}: force start  {bold}h{/bold}: stop  {bold}d{/bold}:delete torrent  {bold}shift+d{/bold}: delete torrent and data')
